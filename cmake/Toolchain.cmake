...
IF(("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang") OR ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU"))
    ...
    SET(ENABLE_DEBUG_DEFINITION "-DDEBUG")
    SET(DISABLE_DEBUG_DEFINITION "-DNDEBUG")
    SET(ENABLE_OPTIMIZATIONS "-O2")
    SET(ENABLE_COVERAGE_INFOS "--coverage")
    SET(DISABLE_EXCEPTION_HANDLING "-fno-exceptions")
...
MACRO(SETUP_COMPILER_FLAGS)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${USE_CXX11_FLAG} ${ENABLE_THREADS}")
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${USE_SIGNED_CHAR_FLAG} ${USE_STRICTEST_RULES_FLAG}")

    SET(CMAKE_CXX_FLAGS_DEBUG "${DISABLE_OPTIMIZATIONS} ${ENABLE_DEBUGGING_SYMBOLS} ${ENABLE_DEBUG_DEFINITION}")
    SET(CMAKE_CXX_FLAGS_RELEASE "${ENABLE_OPTIMIZATIONS} ${DISABLE_DEBUG_DEFINITION}")

    SET(CMAKE_CXX_FLAGS_COVERAGE "${CMAKE_CXX_FLAGS_DEBUG} ${ENABLE_COVERAGE_INFOS} ${DISABLE_EXCEPTION_HANDLING} ${DISABLE_DEBUG_DEFINITION}")
