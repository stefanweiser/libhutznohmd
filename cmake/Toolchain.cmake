...
SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -fPIC -fsigned-char -pipe -pthread -std=c99 -D_POSIX_C_SOURCE=200809L -pedantic -Weverything")
SET(CMAKE_C_FLAGS_COVERAGE "${CMAKE_C_FLAGS_DEBUG} --coverage -fno-inline -fno-inline-small-functions -fno-default-inline")

SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fno-exceptions -fPIC -fsigned-char -pipe -pthread -std=c++11 -pedantic -pedantic-errors -Weverything")
