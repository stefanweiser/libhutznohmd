...
FUNCTION(GET_SOURCE_FILES NAME BASE_DIR VAR)
    FILE(STRINGS "${NAME}" FILES)
    SET(ABS_FILES "")
    FOREACH(F ${FILES})
        GET_FILENAME_COMPONENT(NEW_VAR "${BASE_DIR}/${F}" REALPATH)
        LIST(APPEND ABS_FILES ${NEW_VAR})
    ENDFOREACH()
    SET(${VAR} "${ABS_FILES}" PARENT_SCOPE)
ENDFUNCTION()
