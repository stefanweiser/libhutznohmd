...
TEST(md5, empty)
{
    const md5_array digest = calculate_md5("", 0);
...
{
    const md5_array digest = calculate_md5("Hello World!", 12);
...
TEST(md5, pangram)
{
    const md5_array digest =
        calculate_md5("Pack my box with five dozen liquor jugs", 39);
