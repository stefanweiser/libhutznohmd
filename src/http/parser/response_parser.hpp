...
#ifndef LIBREST_HTTP_PARSER_RESPONSE_PARSER_HPP
#define LIBREST_HTTP_PARSER_RESPONSE_PARSER_HPP
...
public:
    ...
    // input stream and
    //!                    sets the pointer of the current character one byte
    // further. This value
    //!                    must be in [0..255] for valid and less than 0 for
    // invalid character.
    //! @param peek_functor Returns an integer with the current character in the
    // input stream.
    //!                     This value must be in [0..255] for valid and less
    // than 0 for invalid
    //!                     character.
...
#endif // LIBREST_HTTP_PARSER_RESPONSE_PARSER_HPP
