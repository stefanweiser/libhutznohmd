...
url: url url-char { appendToUrl(scanner, yylval); }
     | url-char { appendToUrl(scanner, yylval); }
...
status-code: digit { setStatusCode(scanner, 100, yylval); }
             digit { setStatusCode(scanner, 10, yylval); }
             digit { setStatusCode(scanner, 1, yylval); }

reason-phrase: letter { appendToReasonPhrase(scanner, yylval); }
               reason-phrase-next
               | digit { appendToReasonPhrase(scanner, yylval); }
               reason-phrase-next
reason-phrase-next: reason-phrase-next letter { appendToReasonPhrase(scanner, yylval); }
                  | reason-phrase-next digit { appendToReasonPhrase(scanner, yylval); }
                  | reason-phrase-next ws { appendToReasonPhrase(scanner, yylval); }
                  |
...
header-key: header-key token-char { appendToHeaderKey(scanner, yylval); }
            | token-char { appendToHeaderKey(scanner, yylval); }
header-value: header-value header-content { appendToHeaderValue(scanner, yylval); }
              |
