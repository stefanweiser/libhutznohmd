...
public:
    ...
    static const size_t header_key_size_ = 40;     //!< ...
    static const size_t header_value_size_ = 1000; //!< ...

    lexer lexer_;        //!< ...
    parser_state state_; //!< ...

    push_back_string<header_key_size_> header_key_;     //!< ...
    push_back_string<header_value_size_> header_value_; //!< ...
